...
function example(){return {
 ...
 seller:{name:'Rolands Frukt o Grönt Aktiebolag',address:'Bolshedens Industriväg 22\n427 50 Billdal',orgNumber:'556406-5059',vatNumber:'SE556406505901',phone:'031-00 00 00 (demo)',email:'faktura@example.invalid',website:'https://demo.example.invalid',bankgiro:'DEMO-EJ-BETALNING',taxStatus:'Demo – verifiera skattestatus före skarp drift'},
 buyer:{name:'Exempelkunden AB',address:'Testgatan 10\n411 00 Göteborg',orgNumber:'DEMO-ORG',email:'kund@example.invalid'},
 ourReference:'Rollands referens',yourReference:'Kundens referens',notes:'Tack för er beställning! Detta är en fiktiv exempelfaktura, inte en betalningsbegäran.',
