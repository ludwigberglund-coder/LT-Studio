...
test('reconciliation report endpoints require authentication',()=>run(async f=>{
  for(const route of ['/api/v1/reports/receivables-control','/api/v1/reports/payables-control']){
