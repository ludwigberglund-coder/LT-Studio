...
(async()=>{
  const seller={name:'Demo Handel AB',address:'Exempelgatan 1, 411 00 Göteborg',vatNumber:'SE000000000001',registeredOffice:'Göteborg',invoiceContact:'Exempelkontakt',paymentAccount:'EXEMPEL - EJ FÖR BETALNING'};
