...
test('full private runtime has an explicit tenant scope for every database table', () => {
  ...
  try {
    ...
    assert.deepEqual(report.rootTables,['companies','login_attempts','mfa_used_steps','platform_operator_audit_events','platform_operator_mfa_used_steps','platform_operator_sessions','platform_operators','security_events','users']);
