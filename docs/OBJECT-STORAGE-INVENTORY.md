...
Implementationens externa referenser är Cloudflare R2:s S3-, data-location-, token- och kompatibilitetsdokumentation. Signeringsalgoritmen testas i CI mot AWS officiella S3 SigV4-testvektor, men testcredentialen byggs av separata strängdelar så repositoryts secret-scan inte behöver undantag.
