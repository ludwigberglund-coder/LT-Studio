...
Preview-endpointen är **endast en förhandskontroll** och skriver ingen affärsdata. Det finns även ett separat, uttryckligt bekräftat importflöde som använder samma kontroller innan något skrivs.
...
Den atomiska importen av 1510/2440 tillsammans med reskontraunderlaget finns som ett separat privat API. Den är skyddad med preview-gate, uttrycklig bekräftelse, rollback, idempotens, tenant-isolering och efterföljande 1510/2440-avstämning. Preview-funktionen förblir read-only.
