...
Öppna kundfordringar och leverantörsskulder vid systemstart ska därför inte gå genom denna enkla totalsaldoimport. Sedan PR #354 finns ett separat systembytesflöde där varje öppen post och huvudbokssaldot kontrolleras och importeras tillsammans.
...
Detta endpoint löser fortfarande endast import av vanliga balanskonton. Öppna kund- och leverantörsfakturor vid systemstart hanteras i stället av det separata, källanknutna systembytesflödet i `docs/OPENING-MIGRATION-IMPORT.md`.
