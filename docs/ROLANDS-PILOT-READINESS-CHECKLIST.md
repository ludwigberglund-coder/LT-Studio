...
| Dubbelklick/idempotens i alla affärsflöden | 🟡 Delvis klar | Kundfaktura/kredit använder request-ID. PR 110 verifierar att återförsök inte skapar extra bankhändelse, leverantörsfaktura, färdigt dokument eller bokföringsrättelse. Betalningsflöden har dessutom befintliga idempotensskydd. Återstående mutationer ska fortfarande inventeras systematiskt. |
...
| Fullständig företagsisolering och IDOR | 🟡 Delvis klar | PR 107 utökar objektmatrisen med andra-företags-ID för leverantörsfaktura/PDF, verifikation och dokument samt mutationer mot kundfaktura, leverantörskontering och rättelse med giltig session + CSRF. Inget främmande objekt ändras. Hela route/metodmatrisen och polymorfa länkar återstår. |
...
| Moms i faktura och leverantörsbokföring | 🟡 Delvis klar | Beräkning/konton och normal inhemsk kontering finns. PR 109 verifierar blandade 25/12/6 %-rader i samma kundfaktura och källavstämning mot respektive momskonto. EU/import/momsfritt, krediter över regeländring och övriga specialfall återstår. |
| Momsavstämning mot bokförd huvudbok | 🟡 Delvis klar | PR 109 gör källavstämningen fail-closed: bokförd faktura utan källverifikation, fel bokföringsdatum eller momsbeloppsdifferens flaggas. Blandad 25/12/6 % verifieras mot 2611/2621/2631. Full deklarationslogik, EU/import/momsfritt och periodavslut återstår. |
...
| Fakturadatum, förfallodatum, separat bokföringsdatum | 🟡 Delvis klar | Fält finns åtskilda. PR 108 verifierar den text som faktiskt ritas i kund-PDF:n: fakturadatum och förfallodatum visas medan ett avvikande bokföringsdatum inte visas; bokföringsdatum finns endast på uttryckligt internt underlag. Leveransdatum och full UAT återstår. |
...
| Health/readiness, driftlogg och fungerande larm | 🟡 Delvis klar | PR 95 separerar liveness från readiness. Readiness kontrollerar databasläsning, faktisk skrivbarhet, ledigt diskutrymme och i pilot/produktion en färsk lokal backup med giltig SHA-256. Extern övervakning, central logginsamling, timeout-/felinjektion och fungerande larm återstår. |
| Secrets-hantering och historikskanning | 🟡 Delvis klar | PR 112 gör CI-checkout med full historik och skannar alla nåbara commits efter högkonfidensmönster för privata nycklar och vanliga leverantörstokens utan att logga själva värdet. Faktisk secret manager, nyckelrotation och driftmiljö återstår. |
...
| Betalningsöversikt dag/vecka/månad/kvartal | 🟡 Delvis klar | PR 106 samlar registrerade bankinbetalningar och leverantörsutbetalningar i en privat vy med dag, ISO-vecka, månad och kvartal samt riktning/statusfilter och exakta in/ut/netto-summor. Företagsisolering testas. Fler detaljfilter, sortering och full browser-UAT återstår. |
| Filtrerad Excel-kompatibel export | 🟡 Delvis klar | PR 105 lägger privata UTF-8/Excel-kompatibla CSV-exporter för kundreskontra, kundfakturor, inbetalningar, leverantörsreskontra, leverantörsfakturor, utbetalningar, verifikationer, kontotransaktioner och momsunderlag. Datum/status/konto/period valideras och farliga Excel-formelprefix neutraliseras. Portalens filterkoppling och full browser-UAT återstår. |
...
| K2/K3, momsperiod och bolagsspecifika inställningar | 🟡 Delvis klar | PR 111 skiljer verifierade fakta från målbeslut. Kalenderår stöds av offentliga bokslutsuppgifter för 2024 och momsregistrering är offentlig. K2 och månadsvis moms är fortfarande mål som måste verifieras mot senaste signerade årsredovisning respektive Skatteverket före skarp användning. |
| Driftansvarig, dataskydd, support och pilotstopp | 🟡 Delvis klar | PR 113 gör besluten till en pilot-startspärr: extern operationsfil måste ange tekniskt/redovisnings-/dataskydds-/backup-/övervakningsansvar, incident/supportväg, pilotstopp, rollbackprocess, offsite-backup och retention samt vara uttryckligt godkänd. De verkliga personerna, avtalen och kontaktvägarna återstår att fylla i utanför GitHub. |
...
## Konsoliderad readiness-uppföljning 2026-09-20

PR 94–113 är nu sammanslagna till `main` efter full GitHub Actions-verifiering på respektive aktuell bas. Under denna sekvens lades dokumentintegritet i läsning/restore, maskinläsbar readiness, borttagna kvarvarande rolltexter, filtrerade CSV-exporter, gemensam betalningsöversikt, utökad tenant/IDOR-matris, PDF-datumregression, fail-closed momsavstämning, mutations-idempotensmatris, verifieringsstatus för Rolands redovisningsbeslut, full Git-historikskanning och obligatorisk extern pilot-operationsfil till. Checklistan ovan beskriver endast vad som finns i `main`; externa driftbevis och UAT markeras inte som klara av denna konsolidering. **Samlat beslut är fortsatt NO-GO för verkliga verksamhets- eller bokföringsdata.**
