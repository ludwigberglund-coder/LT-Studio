...
| Kundfordringar, leverantörsskulder, ingående balanser | 🟡 Delvis klar | PR 75 stämmer av kundreskontrasaldo mot 1510 och PR 76 bokförda leverantörsskulder mot 2440. En mänskligt godkänd kundinbetalningsmatchning kan genomföras atomiskt som 1930 debet/1510 kredit för hel- och delbetalning, och fullt reglerade felallokeringar kan omföras utan att ändra den verkliga bankinbetalningen. En strikt ingående-balansimport finns för vanliga balanskonton och blockerar 1510/2440 utan detaljreskontra. En read-only systembytespreview kan nu kontrollera att öppna kundposter exakt motsvarar 1510, öppna leverantörsposter exakt motsvarar 2440, att paketet balanserar och att masterdata hör till rätt företag — utan att skriva någon affärsdata. Själva atomiska importen av öppna kund-/leverantörsposter vid start, kredit efter delbetalning och mer komplex delreskontrarättelse återstår. |
