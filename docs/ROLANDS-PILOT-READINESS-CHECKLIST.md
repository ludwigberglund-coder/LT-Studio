...
| Dubbelklick/idempotens i alla affärsflöden | 🟡 Delvis klar | Kundfaktura/kredit och tidigare kärnflöden är skyddade. PR 212 härdar bank, leverantörsbokföring, betalningsförberedelse/-bekräftelse och lön; betalningsförberedelsens API-audit är idempotent: identiska retries återanvänder samma betalning utan ny audit, medan ändrat datum/konto stoppas. PR 217 gör lagermutationer retry-säkra och PR 221 leverantörsändringar/flera beslut retry-säkra. PR #322 gör även kundskapande retry-säkert: företag + klientens requestId ger deterministiskt kund-ID, identiskt retry återanvänder samma kund/audit och samma requestId med ändrad payload blockeras med 409. Kundportalen återanvänder samma requestId genom hela skapandeförsöket. Fortsatt mutationsinventering krävs för övriga skrivflöden. |
