...
| Dröjsmålsränta och betalningspåminnelser | ✅ Klar | PR 70, #282, #284 och #287 stänger den avgränsade pilotkontrollen: faktisk betalningsdag och payment-reversal delar räntekapitalet; okända referensränteperioder blockeras; exakt regelversion och verifieringsdatum sparas; automatisk ränta kräver verifierad startgrund från SHA-verifierat arkiverat original för systemutställd positiv faktura; importerade/äldre fakturor utan bevis kan endast påminnas utan ränta; kredit/delkredit/manuell justering blockeras fail-closed tills källanknutet stöd finns; skapad/queued/sent leveransstatus hålls isär; identiska påminnelse-retries är idempotenta; regressioner täcker delbetalningsdag, ursprungligt/restkapital, kredit/justering som blockerad väg, räntegränser, årsskifte, skottår, öresavrundning och retries. Framtida automatiskt stöd för källanknuten delkredit ligger separat i #289 och är inte pilotkrav så länge fail-closed-spärren kvarstår. |
...
| Filtrerad Excel-kompatibel export | 🟡 Delvis klar | PR 105 lägger autentiserade Excel-kompatibla CSV-exporter för reskontror, fakturor, in-/utbetalningar, verifikationer, kontotransaktioner och momsunderlag med filtervalidering och formelinjektionsskydd. Betalningsöversiktens Chromium-test verifierar nu att mode, datum, riktning, status, söktext, konto, sortering och ordning förs över exakt till exportlänken. Full browser-UAT för övriga exporttyper återstår. |
...
BLOCKER #65 kan stängas som pilot-säkerhetsblockerare efter PR #284 och #287. Källanknuten automatisk delkredit/justeringsränta är medvetet inte aktiverad; sådana saldohändelser blockeras fail-closed och framtida funktionsstöd följs i #289. **Det samlade NO-GO-beslutet kvarstår på grund av andra öppna readiness-rader, inte på grund av #65.**


## Verifierad koduppföljning 2026-09-21 – avslut av BLOCKER #65

PR #284 gör alla icke verifierade saldoändringar fail-closed i ränteberäkningen och gör identiska ekonomiska påminnelseförsök idempotenta med ett deterministiskt SHA-256-fingeravtryck. Ett identiskt retry återanvänder samma påminnelse och skapar inte en ny auditpost. Kredit, delkredit och generiska manuella justeringar får inte påverka automatisk ränta förrän ett källanknutet historikflöde kan verifiera dem.

PR #287 lägger de sista uttryckliga regressionerna från #65: årsskifte med 366/365 dagar, helt skottår över halvårsgränsen samt deterministisk öresavrundning inklusive exakt halvt öre. Hela GitHub-CI:n var grön före merge.

Den framtida funktionen att automatiskt räkna ränta över källanknutna delkrediter/justeringar följs i #289. Den är inte en kvarvarande pilot-säkerhetslucka eftersom nuvarande system stoppar sådana fall i stället för att gissa. **#65 kan därför stängas som completed; systemets samlade NO-GO kvarstår av andra skäl i denna checklista.**
