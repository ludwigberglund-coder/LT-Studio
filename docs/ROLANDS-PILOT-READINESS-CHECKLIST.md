...
| Arbetslista och begriplig återkoppling | 🟡 Delvis klar | Dashboarden prioriterar konkreta arbetsköer och visar en tydlig varning när någon datakälla inte kan läsas. PR #306 gör dessutom tillgänglighet explicit per område: misslyckade API-anrop visas som `Ej tillgängligt` i nyckeltal och modulbadges i stället för falska nollor, medan fungerande tomma köer fortsatt visas som riktiga 0-värden. Chromium-test simulerar selektivt 503-fel och verifierar detta. PR #314 låser statussemantiken i fem centrala vyer: leverantörsattest är inte bokföring, automationsgodkännande är inte genomförande, prepared/released/paid hålls isär, bankgranskning är inte bokförd inbetalning och sparat fakturautkast är uttryckligen inte bokfört. Bred verklig Rolands-UAT av statusorden återstår. |
...
Hela GitHub-CI:n var grön före merge, inklusive alla ordinarie browserflöden. Detta minskar risken att framtida UI-ändringar blandar ihop affärsstatusar. Raden hålls ändå 🟡 tills verklig Rolands-UAT bekräftar att orden är begripliga i det faktiska arbetssättet.
