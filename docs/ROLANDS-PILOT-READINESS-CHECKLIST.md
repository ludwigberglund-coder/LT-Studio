...
| Rättelse med bibehållen originalhistorik | 🟡 Delvis klar | PR 66: atomisk manuell rättelse med moms, originalkoppling och audit; osäkra fristående rättelser av automatiska poster och 151x/244x nekas. Källanknuten rättelse av en bokförd leverantörsbetalning återför nu betalningsverifikationen, öppnar 2440/reskontran igen, bevarar bankreferens och försökshistorik och tillåter en ny kontrollerad betalningsbokföring. Kundbetalningsrättelse återstår eftersom den privata bankmatchningen fortfarande stannar vid godkänt förslag och inte exekverar kundbetalningen. |
...
| Kundfordringar, leverantörsskulder, ingående balanser | 🟡 Delvis klar | PR 75 stämmer av aktuellt kundreskontrasaldo mot konto 1510 och PR 76 bokförda leverantörsskulder mot 2440. En strikt ingående-balansimport finns nu för balanskonton i klass 1–2: den är retry-säker, auditerad, måste ske 1 januari innan årets övriga verifikationer och blockerar 1510/2440 utan reskontraunderlag. Öppna kund-/leverantörsposter vid start samt kompletta källanknutna rättelseflöden återstår fortfarande. |
