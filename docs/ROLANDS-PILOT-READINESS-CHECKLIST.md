...
| Fakturadatum, förfallodatum, separat bokföringsdatum | 🟡 Delvis klar | PR 101 tar bort manuellt bokföringsdatum från kundfakturans skapandevy. Fakturadatum och förfallodatum är de synliga fakturadatumfälten; bokföringsdatum synkas internt till fakturadatum när datumet ändras. Kund-PDF:n visar fakturadatum och förfallodatum men inte bokföringsdatum. Full pilot-UAT och specialfall för separat bokföringsdag återstår. |
| Återanvändning av kunddata och inget artikelnummerkrav | 🟡 Delvis klar | Kundnamn, organisationsnummer, adress och e-post hämtas låst från kundregistret i kundfakturavyn. Artikelnummer visas inte som fakturaradsfält och skickas endast som tomt tekniskt kompatibilitetsvärde. Betalningsvillkor/referenser och full UAT behöver fortfarande verifieras. |
...
## Verifierad uppföljning 2026-09-20 – synliga kundfakturadatum

PR 101 förenklar kundfakturans skapandevy. Användaren anger fakturadatum och ser beräknat förfallodatum; bokföringsdatum visas inte längre som ett separat manuellt fakturafält. När fakturadatum ändras sätts bokföringsdatum internt till samma datum och skickas fortsatt till bokföringsmotorn. Kund-PDF:ns offentliga del visar fakturadatum och förfallodatum, medan bokföringsdatum endast får förekomma i uttryckligt internt PDF-underlag. Regressionstest bevakar både formulär och PDF. Kunddata är fortsatt registerstyrd och artikelnummer saknas i användarens fakturarader. **NO-GO kvarstår.**
