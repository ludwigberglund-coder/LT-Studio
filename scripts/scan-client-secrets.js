...
const SECRET_NAME=/\b(?:CLOUDFLARE_API_TOKEN|CF_API_TOKEN|CF_API_KEY|TINK_CLIENT_SECRET|BANKID_CLIENT_SECRET|R2_(?:STAGING|BACKUP|AUDIT)_(?:ACCESS_KEY_ID|SECRET_ACCESS_KEY|SESSION_TOKEN)|ROLLANDS_(?:AUTH_ENCRYPTION_KEY|BACKUP_ENCRYPTION_KEY|BOOTSTRAP_PASSWORD|BOOTSTRAP_MFA_SECRET))\b/;
