...
function overviewView(){
  ...
  shell(`<section class="hero-dashboard">
    ...
    <div class="hero-gauges">${ringGauge(health,'Drift','Godkända tekniska hälsokontroller.')}${ringGauge(configuredPct,'Aktivering','Företag med minst en aktiv användare.')}${ringGauge(100-securityPenalty,'Säkerhet','Baserat på aktuella varningar senaste 24 h.',toneForPercent(100-securityPenalty))}</div>
  </section>
