...
function overviewView(){
  ...
  shell(`<section class="hero-dashboard">
    ...
    <div class="hero-gauges">${ringGauge(health,'Drift','Godkända tekniska hälsokontroller.')}${ringGauge(configuredPct,'Aktivering','Företag med minst en aktiv användare.')}${ringGauge(100-securityPenalty,'Säkerhetssignaler','Visuell 24 h-indikator från varningar och kritiska händelser — inte ett säkerhetsbetyg.',toneForPercent(100-securityPenalty))}</div>
  </section>
