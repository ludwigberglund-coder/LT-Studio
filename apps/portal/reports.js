...
let session=null,reportType='trial',fromDate='2026-09-01',toDate='2026-09-30',period='2026-09',report=null,message='';
...
async function loadReport(){
  if(isDemo){report=demoReport();render();return}
  if(reportType==='trial')report=await api(`/reports/trial-balance?from=${fromDate}&to=${toDate}`);
