(function(){
  ...
  const PAGE_REALTIME_TABLES=Object.freeze({
    ...
    'supplier-invoices.html':['suppliers','supplier_invoices','supplier_payments','documents','financial_batches'],
    'supplier-ledger.html':['suppliers','supplier_invoices','supplier_payments','documents','financial_batches'],
