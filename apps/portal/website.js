...
function setPreview(){
  if(!isDemo)throw new Error('Privata utkast f\u00f6rhandsvisas fr\u00e5n servern.');
...
async function previewDraft(){
  ...
  tab.opener=null;
  try{if(isDemo)tab.location.href=setPreview();else{await saveDraft();tab.location.href='/website-preview/';}}
