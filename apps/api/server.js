...
const {createAccountingRouter} = require('./accounting-router.js');
...
function createServer(options = {}) {
  ...
  const accounting = createAccountingRouter({db});
  ...
  return Object.freeze({server,db,api,automationReview,bank,payables,supplierMasterdata,paymentRelease,paymentConfirmation,accounting,host,port,databasePath,close});
}
