...
function releasePayment(db,{companyId,paymentId,releasedBy}){
  ...
  if(payment.preparedBy===releasedBy)throw paymentError('Den som förberedde betalningen får inte ensam frisläppa samma betalning.','SEPARATION_OF_DUTIES_FAILED',409);
