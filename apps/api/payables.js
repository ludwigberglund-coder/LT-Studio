...
module.exports=Object.freeze({initializePayables,listSuppliers,createSupplier,createSupplierIdempotent,supplierById,supplierByNumber,createSupplierInvoice,createSupplierInvoiceIdempotent,invoiceById,listInvoices,supplierHistory,storeDocument,storeDocumentIdempotent,document,privateObjectMetadata,saveCoding,saveCodingIdempotent,approve,preparePayment,paymentByInvoice,paymentById,listPayments,validDate,normalizeInvoiceNumber,duplicateInvoice,duplicateDocument});
