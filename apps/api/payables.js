...
module.exports=Object.freeze({initializePayables,listSuppliers,createSupplier,supplierById,supplierByNumber,createSupplierInvoice,createSupplierInvoiceIdempotent,invoiceById,listInvoices,supplierHistory,storeDocument,document,privateObjectMetadata,saveCoding,approve,preparePayment,paymentByInvoice,paymentById,listPayments,validDate,normalizeInvoiceNumber,duplicateInvoice,duplicateDocument});
