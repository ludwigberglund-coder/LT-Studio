  ...
  <div class="site-shell">
    ...
    <main>
      ...
      <section class="public-section tinted" id="foretagsfrukt"><div class="section-inner">
        ...
        <div class="service-grid"><article class="service-card"><div class="mark" data-iconoir="appleHalf"></div><h3>Frukt på jobbet</h3><p>Välfyllda fruktleveranser som passar kontorets rytm och säsong.</p></article><article class="service-card"><div class="mark" data-iconoir="deliveryTruck"></div><h3>Delibrickor</h3><p>Väl valda ostar, charkuterier och tillbehör för möten och firanden.</p></article><article class="service-card" id="catering"><div class="mark" data-iconoir="cutlery"></div><h3>Catering</h3><p>Mat med bra råvaror och omsorg för små och stora tillfällen.</p></article></div>
      </div></section>
