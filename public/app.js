    ...
    <main>
      <section class="hero" id="butiken">
        <div>
          ...
          <div class="hero-actions"><a class="button" href="#kontakt">Besök vår butik <span>→</span></a><a class="button alt" href="#foretagsfrukt">Företagsfrukt</a></div>
        </div>
