(function(root, factory) {
  ...
  const sections = [
    ...
    { code: '3', title: 'Rörelsens inkomster/intäkter', accounts: [
      ['3000','Försäljning och utfört arbete samt övriga momspliktiga intäkter','R1'], ['3010','Försäljning varor','R1'],
      ['3041','Försäljning tjänster, 25 % moms','R1'], ['3051','Försäljning varor, 25 % moms','R1'], ['3052','Försäljning varor, 12 % moms','R1'],
      ['3053','Försäljning varor, 6 % moms','R1'], ['3054','Försäljning varor, momsfri','R2'], ['3100','Momsfria intäkter','R2'],
    ...
    { code: '4', title: 'Utgifter/kostnader för varor, material och vissa köpta tjänster', accounts: [
      ['4000','Varor','R5'], ['4010','Inköp av varor','R5'], ['4600','Legoarbeten och underentreprenader','R5'], ['4700','Erhållna rabatter, bonus etc.','R6'], ['4900','Förändring av lager','R5']
    ]},
    { code: '5–6', title: 'Övriga externa rörelseutgifter/kostnader', accounts: [
      ['5000','Lokalkostnader','R6'], ['5020','El för belysning','R6'], ['5060','Städning och renhållning','R6'], ['5100','Fastighetskostnader','R6'], ['5200','Hyra av anläggningstillgångar','R6'],
      ['5400','Förbrukningsinventarier och förbrukningsmaterial','R6'], ['5410','Förbrukningsinventarier','R6'], ['5460','Förbrukningsmaterial','R6'], ['5500','Reparation och underhåll','R6'], ['5600','Kostnader för transportmedel','R6'],
      ...
      ['5620','Lastbilskostnader','R6'], ['5700','Frakter och transporter','R6'], ['5710','Frakter och transporter','R6'], ['5800','Resekostnader','R6'], ['5900','Reklam och PR','R6'],
      ...
      ['6100','Kontorsmateriel och trycksaker','R6'], ['6200','Tele och post','R6'], ['6300','Företagsförsäkringar och övriga riskkostnader','R6'], ['6310','Företagsförsäkringar','R6'],
      ['6351','Konstaterade kundförluster','R6'], ['6500','Övriga externa tjänster','R6'], ['6570','Bankkostnader','R6'], ['6800','Inhyrd personal','R6'],
      ['6900','Övriga kostnader','R6'], ['6980','Föreningsavgifter','R6'], ['6990','Övriga externa kostnader','R6']
    ]},
