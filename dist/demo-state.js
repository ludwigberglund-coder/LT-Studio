...
window.ROLLANDS_DEMO = {
  schemaVersion: 4,
  business: { name: 'Rollands Frukt och Grönt AB', displayName: 'Rollands Saluhall', orgNumber: '556406-5059', address: 'Bolshedens Industriväg 22, 427 50 Billdal', phone: '031-91 32 23', email: 'frukt@rollands.se', vatNumber: 'SE556406505901', registeredOffice: 'Göteborg', invoiceContact: 'Anna Åberg', paymentAccount: 'Handelsbanken 6000-123 456', sni: '47210 – Detaljhandel med frukt och grönsaker' },
  settings: { fiscalYear: '2026-01-01 – 2026-12-31', bankAccount: '1930 Företagskonto', emailInbox: 'fakturor@rollands.se', aiAutoBookLimit: 0.92 },
  invoices: [
    { id:'demo_i1', number:'2026-1101', customerNumber:'K-2001', customer:'Västra Hamnen Logistik AB', address:'Hamngatan 4, 411 14 Göteborg', reference:'Företagsfrukt september', ourContact:'Anna Åberg', date:'2026-09-04', dueDate:'2026-10-04', total:5000, net:4000, vat:1000, status:'Bokförd', paid:false, payments:[{id:'demo_p1',amount:2500,date:'2026-09-12',method:'Bank',reference:'HB-DEMO-1101',journalNumber:'A100'}] },
    { id:'demo_i2', number:'2026-1102', customerNumber:'K-2001', customer:'Västra Hamnen Logistik AB', address:'Hamngatan 4, 411 14 Göteborg', reference:'Korrigering av leverans', ourContact:'Anna Åberg', date:'2026-09-10', dueDate:'2026-10-10', total:-800, net:-714, vat:-86, credit:true, status:'Kredit', paid:false, payments:[] },
...
(() => {
  ...
  s.supplierInvoices.push(
    ...
    {id:'test_s05',supplier:'Billdal Kontorsmaterial AB',supplierNumber:'L-4105',invoiceNumber:'BK-44381',received:'2026-09-10',dueDate:'2026-09-23',total:1280,net:1143,vat:137,suggestedAccount:'5460 Förbrukningsmaterial',status:'Attest väntar',source:'E-post PDF',confidence:.74,payments:[]},
